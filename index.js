...
const totalContributionsWCommas = totalContributions.toLocaleString('en-US');
contributionsCard.innerHTML = `
<p>Total Contributions: ${totalContributionsWCommas}
`;
...
raisedCard.innerHTML = `<p>Total Raised: $${totalRaisedFormatted}`;

// grab number of games card and set its inner HTML
const gamesCard = document.getElementById("num-games");
const totalGames = GAMES_JSON.length;
gamesCard.innerHTML = `<p> Total Games: ${totalGames}`;
...
let UnfundedStr = `A total of $${totalRaised} has been raised for ${totalGames} games. Currently 
${UnfundedCount} ${UnfundedCount === 1 ? 'game' : 'games'} remain unfunded. 
We could use your help funding these games! `
...
messageCard.innerHTML = templateString;

descriptionContainer.appendChild(messageCard);
...
firstGameCard.innerHTML = `<p>${firstGame.name}`;
